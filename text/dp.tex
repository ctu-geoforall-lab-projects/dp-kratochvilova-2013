...
lead to higher error rate comparing with using a 2D representation.
...
which lead to the first GUI prototype called \emph{TCLTKGRASS}
written in \emph{Tcl} programming language using \emph{Tk} graphical toolkit.
...
In 2006, it was decided to build a new GUI based on wxPyton\,---\, a Python wrapper
for cross-platform GUI toolkit \emph{wxWidgets}.
