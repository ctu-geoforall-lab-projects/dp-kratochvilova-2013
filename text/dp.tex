...
New features:
    \begin{description}
      ...
      A nice feature is the ability to animate the raster maps in 3D view.
      The raster maps can either represent a changing color of a static surface or
      a changing surface.
...
Unfortunately, reloading all maps in this way would be more time-consumming.
