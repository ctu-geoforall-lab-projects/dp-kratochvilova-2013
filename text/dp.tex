...
STempo consists of different views including a map, a timeline,
...
Tracking Analyst is an extension for spatio-temporal data focused on vector data \cite{arcgisHelp}.
