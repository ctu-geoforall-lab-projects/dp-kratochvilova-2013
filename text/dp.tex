...
\usepackage[sorting=none,hyperref=auto]{biblatex}
...
\subsubsection{Support of the \tf}
...
Unfortunately, the mechanism of loading raster data in \mod{xganim} could not be simply rewritten into Python because of performance issues.
...
\paragraph{Checking compatibility of data}
