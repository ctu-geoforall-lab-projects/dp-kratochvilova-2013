...
An example of the usage is presented in figure \ref{fig:mapswipe}
...
Therefore, the class responsible for drawing map,
overlays and zooming functionality (class \verb|BufferedWindow|) was subclassed.
The \ms consists of two instances of this new class which are
inside a wxPython widget \verb|wx.SplitterWindow|. This widget manages the layout of the windows.
In figure \ref{fig:mapswipe_swipe}, there is a narrow light border in the middle; this border
is actually the part of the  \verb|wx.SplitterWindow| (this part is called \emph{sash}).
Since the goal was the described behavior, it was necessary to `pretend' that there is only one window
where one of the map lies over the second one.


The achieve desired behavior, 
