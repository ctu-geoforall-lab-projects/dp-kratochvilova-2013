...
do
    let NUM++
    m.nviz.image elevation_map=$map format=tif output=${IMG}_$NUM \
    zexag=4 persp=12 height=300
done
...
\begin{figure}[h!]
  ...
  \caption{Functionality of module \module{r.to.rast3}. Source: GRASS GIS 7.0 Reference Manual \cite{grassUserMan}.}
  \label{fig:rtorast3}
\end{figure}
