...
According to \cite{temporalGlossary}, event ``is an instantaneous fact, i.e., something occurring at an instant''.
...
the raster-based approach implemented by Peuquet and Duan, called 
...
Pelekis \cite{pelekis2004} claims that it can ``support  all types of data handling,
